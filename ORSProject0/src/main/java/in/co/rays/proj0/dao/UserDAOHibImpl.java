...
public class UserDAOHibImpl implements UserDAOInt {
	...
	SessionFactory sessionFactory;
	  ...
	  public void setSessionFactory(SessionFactory sessionFactory) { System.out.
	  println("This is @Autowired setSessionFactory method in User DAO Hibernate Implementation"
